...
function MFish() {
  (this.x = 0), (this.y = 0), (this.rad = 0), (this.dir = new Point(1, 1));
}
function View(t) {
  Sprite.call(this),
    (this.model = t),
...
function Panel() {
  Sprite.apply(this), (this.hidden = !1);
...
(KAPI.GetScorePublic = function () {
  return KAPI._spublic;
}),
  (KAPI.SetScorePublic = function (t, e) {
    (KAPI._spublic = t),
      (KAPI._savedResp = e),
      KAPI.SaveRecord(KAPI.GetRecord());
  }),
  (KAPI.LoadScores = function (t, e, i) {
    KAPI._scoreResp = i;
    ...
    s.open(
      ...
      (s.onload = KAPI._scoresLoaded),
      s.send();
  }),
  (KAPI._scoresLoaded = function (t) {
    var e = JSON.parse(t.target.response);
    KAPI._scoreResp(e.scores);
  }),
  ...
  (KAPI._receiveMessage = function (t) {
    var e = t.data.split(',');
    'kapi_logged_in' == e[0] &&
      ((localStorage[KAPI._appID + '_uid'] = e[1]),
      KAPI._setToken(e[2]),
      (localStorage[KAPI._appID + '_provider'] = e[3]),
      KAPI._loginWindow.close(),
      location.reload());
  }),
  ...
  (KAPI._setToken = function (t) {
    var e = localStorage[KAPI._appID + '_token'];
    (null != e && parseInt(t.split('-')[0]) < parseInt(e.split('-')[0])) ||
      ((localStorage[KAPI._appID + '_token'] = t),
      clearTimeout(KAPI._resendTO),
      (KAPI._resendTO = setTimeout(
        KAPI._resend,
  ...
  (Model.prototype.SetFishPos = function (t, e) {
    (this.mfish.x = t), (this.mfish.y = e);
  }),
  (Model.prototype.Step = function (t) {
    ...
    for (var s = 0; s < this.fishes.length; s++) {
      ...
      h.x < -this.maprx - i
        ? (h.SetDir(n, a * o), h.SetRad(Model.around(e)))
        : h.x > this.maprx + i &&
          (h.SetDir(-n, a * o), h.SetRad(Model.around(e))),
        h.y < -this.mapry - i
          ? (h.SetDir(a * n, o), h.SetRad(Model.around(e)))
          : h.y > this.mapry + i &&
            (h.SetDir(a * n, -o), h.SetRad(Model.around(e))),
  ...
  (Model.prototype.ResetFish = function (t) {
    var e = this.fishes[t];
    e.SetRad(Model.around(this.mfish.rad));
  ...
  (Model.prototype.SetSizeRatio = function (t) {
  ...
  (MFish.prototype.SetRad = function (t) {
    this.rad = t;
  }),
  (MFish.prototype.AddToRad = function (t) {
    this.rad += t;
  }),
  (MFish.prototype.SetDir = function (t, e) {
    (this.dir.x = t), (this.dir.y = e);
  }),
  (Model.around = function (t) {
    return t * (0.75 + 1.2 * Math.random());
  }),
  ...
  (Controller.prototype.apiInit = function () {
  ...
  (Controller.prototype.resize = function (t, e) {
  ...
  (Controller.prototype.onEF = function (t) {
    if (!this.paused) {
  ...
  (BFMain.prototype.showIntro = function (t) {
  ...
  (BFMain.prototype.init = function () {
  ...
  (BFMain.prototype.resize = function (t, e) {
    Resizable.prototype.resize.call(this, t, e),
  ...
  (BFMain.prototype.over = function (t) {
    this.panel.Show(300);
  }),
  (BFMain.prototype.goPlay = function (t) {
    this.panel.Hide(1200), this.game.Start();
  }),
  (Background.prototype = new Resizable()),
  (Background.prototype.resize = function (t, e) {
    this.w;
    Resizable.prototype.resize.call(this, t, e),
  ...
  (Background.prototype.onBDLoaded = function (t) {
    this.resize(this.w, this.h);
  }),
  (Background.prototype.UpdateScale = function (t) {
  ...
  (Background.prototype.onEF = function (t) {
    var e = t.target;
    ++e.t;
  ...
  (Panel.prototype.Hide = function (t) {
  ...
  (Fish.prototype.UpdateRadDir = function (t, e) {
    if (t != this.rad) {
  ...
  (FlipNum.prototype.SetNum = function (t) {
    t != this.tnum &&
      ((this.tnum = t),
  ...
  (FlipNum.prototype.SetDirectly = function (t) {
    t != this.tnum &&
  ...
  (FlipNum.prototype.onEF = function (t) {
    this.cnum == this.tnum &&
